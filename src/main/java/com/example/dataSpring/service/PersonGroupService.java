...
public class PersonGroupService {
    ...
    public List<Person> findPeopleByGroupId(Integer groupId){
        return this.personGroupRepository.findPeopleByGroupId(groupId);
    }
    public void deleteAllPersonInGroup(Integer groupId){
